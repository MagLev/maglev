...
class Time
  class << Time
    ...
    # LeapYearMonthDays loaded by Bootstrap
    # CommonYearMonthDays loaded by Bootstrap
    ...
    # MonthValue loaded by bootstrap/Time.rb
  ...
  # RFC2822_DAY_NAME loaded by bootstrap/Time.rb
  # RFC2822_MONTH_NAME loaded by bootstrap/Time.rb
