class CZstream
    ...
    class_primitive_nobridge '__adler32', 'adler32:initialCrc:'
    class_primitive_nobridge '__crc_table', 'crcTable'
    class_primitive_nobridge '__crc32', 'crc32:initialCrc:'
end
module Zlib

  ZStream = ::CZstream
end
Zlib.__freeze_constants
