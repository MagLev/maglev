...
#
# Usage:  
# $JRUBY_HOME/jruby -J-Xss1024m -J-Xmn512m -J-Xms2048m -J-Xmx2048m -J-server ./run_benchmarks-JRuby.rb 1>benchmark_results-JRuby-${HOSTNAME}-`date +%y%m%d`.out 2>&1
#
...
# require '../benchmark/cangiano/micro-benchmarks/bm_thread_ring.rb' # Hangs
