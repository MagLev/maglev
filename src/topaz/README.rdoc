...
== Playing with Seaside

If you want to use a GemTools One-Click Pharo image at
http://seaside.gemstone.com/squeak/GemTools-MagLev-Pharo-1.0.zip
instead of running these in Topaz, you'll need to start both MagLev
and a NetLDI
    maglev start
    maglev startnetldi
    
TODO: Turn some of these Seaside code snippets into Topaz scripts in
