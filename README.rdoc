...
The MagLev Alpha version on 2011-06-07 is 25943. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25943
  ./upgradeMaglev.sh 25943
...
<tt>rvm use maglev-25943; maglev stop; rvm use maglev-head; maglev stop</tt>.
