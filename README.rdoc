...
The MagLev Alpha version on 2011-06-07 is 25940. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25940
  ./upgradeMaglev.sh 25940
...
<tt>rvm use maglev-25940; maglev stop; rvm use maglev-head; maglev stop</tt>.
