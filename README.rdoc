...
The MagLev Alpha version on 2011-07-26 is 26273. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 26273
  ./upgradeMaglev.sh 26273
...
<tt>rvm use maglev-26273; maglev stop; rvm use maglev-head; maglev stop</tt>.
