...
The MagLev Alpha version on 2011-03-18 is 25506. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25506
  ./upgradeMaglev.sh 25506
...
<tt>rvm use maglev-25506; maglev stop; rvm use maglev-head; maglev stop</tt>.
