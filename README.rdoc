...
The MagLev Alpha version on 09-Feb-10 is 22853. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 22853
  ./upgradeMaglev.sh 22853
...
<tt>rvm use maglev-22853; maglev stop; rvm use maglev-head; maglev stop</tt>.
