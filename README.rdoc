...
The MagLev Alpha version on 2011-05-25 is 25898. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25898
  ./upgradeMaglev.sh 25898
...
<tt>rvm use maglev-25898; maglev stop; rvm use maglev-head; maglev stop</tt>.
