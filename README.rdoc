...
The MagLev Alpha version on 2011-05-12 is 25850. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25850
  ./upgradeMaglev.sh 25850
...
<tt>rvm use maglev-25850; maglev stop; rvm use maglev-head; maglev stop</tt>.
