...
The MagLev Alpha version on 2010-12-21 is 24906. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 24906
  ./upgradeMaglev.sh 24906
...
<tt>rvm use maglev-24906; maglev stop; rvm use maglev-head; maglev stop</tt>.
