...
The MagLev Alpha version on 02-Feb-10 is 22814. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 22814
  ./upgradeMaglev.sh 22814
...
<tt>rvm use maglev-22814; maglev stop; rvm use maglev-head; maglev stop</tt>.
