...
The MagLev Alpha version on 11-Feb-10 is 22866. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 22866
  ./upgradeMaglev.sh 22866
...
<tt>rvm use maglev-22866; maglev stop; rvm use maglev-head; maglev stop</tt>.
