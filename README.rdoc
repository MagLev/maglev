...
The MagLev Alpha version on 2011-05-02 is 25779. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25779
  ./upgradeMaglev.sh 25779
...
<tt>rvm use maglev-25779; maglev stop; rvm use maglev-head; maglev stop</tt>.
