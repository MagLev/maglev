...
The MagLev Alpha version on 2011-04-08 is 25673. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25673
  ./upgradeMaglev.sh 25673
...
<tt>rvm use maglev-25673; maglev stop; rvm use maglev-head; maglev stop</tt>.
