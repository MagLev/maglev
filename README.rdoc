...
The MagLev Alpha version on 2010-09-22 is 24294. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 24294
  ./upgradeMaglev.sh 24294
...
<tt>rvm use maglev-24294; maglev stop; rvm use maglev-head; maglev stop</tt>.
