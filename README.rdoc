...
The MagLev Alpha version on 2010-04-06 is 23191. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23191
  ./upgradeMaglev.sh 23191
...
<tt>rvm use maglev-23191; maglev stop; rvm use maglev-head; maglev stop</tt>.
