...
The MagLev Alpha version on 2011-03-16 is 25480. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25480
  ./upgradeMaglev.sh 25480
...
<tt>rvm use maglev-25480; maglev stop; rvm use maglev-head; maglev stop</tt>.
