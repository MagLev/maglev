...
The MagLev Alpha version on 2011-02-18 is 25289. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25289
  ./upgradeMaglev.sh 25289
...
<tt>rvm use maglev-25289; maglev stop; rvm use maglev-head; maglev stop</tt>.
