...
The MagLev Alpha version on 2011-05-24 is 25893. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25893
  ./upgradeMaglev.sh 25893
...
<tt>rvm use maglev-25893; maglev stop; rvm use maglev-head; maglev stop</tt>.
