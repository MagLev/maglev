...
The MagLev Alpha version on 22-Jan-10 is 22771. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 22771
  ./upgradeMaglev.sh 22771
...
<tt>rvm use maglev-22683; maglev stop; rvm use maglev-22771; maglev stop</tt>.
