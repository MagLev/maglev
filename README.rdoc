...
The MagLev Alpha version on 2010-03-19 is 23081. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23081
  ./upgradeMaglev.sh 23081
...
<tt>rvm use maglev-23081; maglev stop; rvm use maglev-head; maglev stop</tt>.
