...
The MagLev Alpha version on 2011-08-09 is 26386. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 26386
  ./upgradeMaglev.sh 26386
...
<tt>rvm use maglev-26386; maglev stop; rvm use maglev-head; maglev stop</tt>.
