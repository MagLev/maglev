...
The MagLev Alpha version on 2011-02-16 is 25265. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25265
  ./upgradeMaglev.sh 25265
...
<tt>rvm use maglev-25265; maglev stop; rvm use maglev-head; maglev stop</tt>.
