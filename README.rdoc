...
The MagLev Alpha version on 2011-02-23 is 25315. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25315
  ./upgradeMaglev.sh 25315
...
<tt>rvm use maglev-25315; maglev stop; rvm use maglev-head; maglev stop</tt>.
