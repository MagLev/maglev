...
The MagLev Alpha version on 2010-02-26 is 22923. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 22923
  ./upgradeMaglev.sh 22923
...
<tt>rvm use maglev-22923; maglev stop; rvm use maglev-head; maglev stop</tt>.
