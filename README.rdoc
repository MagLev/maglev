...
The MagLev Alpha version on 2011-04-12 is 25691. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25691
  ./upgradeMaglev.sh 25691
...
<tt>rvm use maglev-25691; maglev stop; rvm use maglev-head; maglev stop</tt>.
