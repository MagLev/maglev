...
The MagLev Alpha version on 2011-07-19 is 26204. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 26204
  ./upgradeMaglev.sh 26204
...
<tt>rvm use maglev-26204; maglev stop; rvm use maglev-head; maglev stop</tt>.
