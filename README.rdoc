...
The MagLev Alpha version on 2011-03-02 is 25359. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25359
  ./upgradeMaglev.sh 25359
...
<tt>rvm use maglev-25359; maglev stop; rvm use maglev-head; maglev stop</tt>.
