...
The MagLev Alpha version on 2011-08-22 is 26496. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 26496
  ./upgradeMaglev.sh 26496
...
<tt>rvm use maglev-26496; maglev stop; rvm use maglev-head; maglev stop</tt>.
