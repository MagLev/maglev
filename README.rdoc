...
The MagLev Alpha version on 2010-08-23 is 24126. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 24126
  ./upgradeMaglev.sh 24126
...
<tt>rvm use maglev-24126; maglev stop; rvm use maglev-head; maglev stop</tt>.
