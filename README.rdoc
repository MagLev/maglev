...
The MagLev Alpha version on 2010-12-21 is 24905. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 24905
  ./upgradeMaglev.sh 24905
...
<tt>rvm use maglev-24905; maglev stop; rvm use maglev-head; maglev stop</tt>.
