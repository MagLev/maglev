...
The MagLev Alpha version on 2010-12-13 is 24854. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 24854
  ./upgradeMaglev.sh 24854
...
<tt>rvm use maglev-24854; maglev stop; rvm use maglev-head; maglev stop</tt>.
