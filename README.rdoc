...
The MagLev Alpha version on 2010-08-06 is 23996. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23996
  ./upgradeMaglev.sh 23996
...
<tt>rvm use maglev-23996; maglev stop; rvm use maglev-head; maglev stop</tt>.
