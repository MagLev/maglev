...
The MagLev Alpha version on 2010-05-07 is 23460. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23460
  ./upgradeMaglev.sh 23460
...
<tt>rvm use maglev-23460; maglev stop; rvm use maglev-head; maglev stop</tt>.
