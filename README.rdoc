...
The MagLev Alpha version on 22-Jan-10 is 22774. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 22774
  ./upgradeMaglev.sh 22774
...
<tt>rvm use maglev-22774; maglev stop; rvm use maglev-head; maglev stop</tt>.
