...
The MagLev Alpha version on 2011-04-08 is 25670. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 26570
  ./upgradeMaglev.sh 26570
...
<tt>rvm use maglev-26570; maglev stop; rvm use maglev-head; maglev stop</tt>.
