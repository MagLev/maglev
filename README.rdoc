...
The MagLev Alpha version on 2010-03-09 is 22985. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 22985
  ./upgradeMaglev.sh 22985
...
<tt>rvm use maglev-22985; maglev stop; rvm use maglev-head; maglev stop</tt>.
