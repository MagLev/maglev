...
The MagLev Alpha version on 2010-05-05 is 23448. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23448
  ./upgradeMaglev.sh 23448
...
<tt>rvm use maglev-23448; maglev stop; rvm use maglev-head; maglev stop</tt>.
