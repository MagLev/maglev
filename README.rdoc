...
The MagLev Alpha version on 2011-08-17 is 26436. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 26436
  ./upgradeMaglev.sh 26436
...
<tt>rvm use maglev-26436; maglev stop; rvm use maglev-head; maglev stop</tt>.
