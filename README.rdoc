...
The MagLev Alpha version on 2011-07-21 is 26230. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 26230
  ./upgradeMaglev.sh 26230
...
<tt>rvm use maglev-26230; maglev stop; rvm use maglev-head; maglev stop</tt>.
