...
The MagLev Alpha version on 2011-05-04 is 25801. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25801
  ./upgradeMaglev.sh 25801
...
<tt>rvm use maglev-25801; maglev stop; rvm use maglev-head; maglev stop</tt>.
