...
The MagLev Alpha version on 2011-07-19 is 26197. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 26197
  ./upgradeMaglev.sh 26197
...
<tt>rvm use maglev-26197; maglev stop; rvm use maglev-head; maglev stop</tt>.
