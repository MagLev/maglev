...
The MagLev Alpha version on 2010-12-23 is 24924. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 24924
  ./upgradeMaglev.sh 24924
...
<tt>rvm use maglev-24924; maglev stop; rvm use maglev-head; maglev stop</tt>.
