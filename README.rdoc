...
The MagLev Alpha version on 2011-07-20 is 26208. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 26208
  ./upgradeMaglev.sh 26208
...
<tt>rvm use maglev-26208; maglev stop; rvm use maglev-head; maglev stop</tt>.
