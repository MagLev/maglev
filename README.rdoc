...
The MagLev Alpha version on 2011-03-28 is 25572. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25572
  ./upgradeMaglev.sh 25572
...
<tt>rvm use maglev-25572; maglev stop; rvm use maglev-head; maglev stop</tt>.
