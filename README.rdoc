...
The MagLev Alpha version on 2011-02-26 is 25343. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25343
  ./upgradeMaglev.sh 25343
...
<tt>rvm use maglev-25343; maglev stop; rvm use maglev-head; maglev stop</tt>.
