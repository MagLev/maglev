...
The MagLev Alpha version on 2010-08-06 is 23981. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23981
  ./upgradeMaglev.sh 23981
...
<tt>rvm use maglev-23981; maglev stop; rvm use maglev-head; maglev stop</tt>.
