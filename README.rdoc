...
The MagLev Alpha version on 2011-02-15 is 25260. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25260
  ./upgradeMaglev.sh 25260
...
<tt>rvm use maglev-25260; maglev stop; rvm use maglev-head; maglev stop</tt>.
