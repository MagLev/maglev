...
The MagLev Alpha version on 2010-11-01 is 24563. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 24563
  ./upgradeMaglev.sh 24563
...
<tt>rvm use maglev-24563; maglev stop; rvm use maglev-head; maglev stop</tt>.
