...
The MagLev Alpha version on 2010-10-20 is 24518. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 24518
  ./upgradeMaglev.sh 24518
...
<tt>rvm use maglev-24518; maglev stop; rvm use maglev-head; maglev stop</tt>.
