...
The MagLev Alpha version on 2011-04-03 is 25628. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25628
  ./upgradeMaglev.sh 25628
...
<tt>rvm use maglev-25628; maglev stop; rvm use maglev-head; maglev stop</tt>.
