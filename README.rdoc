...
The MagLev Alpha version on 2010-03-02 is 22949. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 22949
  ./upgradeMaglev.sh 22949
...
<tt>rvm use maglev-22949; maglev stop; rvm use maglev-head; maglev stop</tt>.
