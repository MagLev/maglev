...
The MagLev Alpha version on 2010-09-02 is 24192. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 24192
  ./upgradeMaglev.sh 24192
...
<tt>rvm use maglev-24192; maglev stop; rvm use maglev-head; maglev stop</tt>.
