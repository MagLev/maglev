...
The MagLev Alpha version on 2011-01-18 is 25051. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25051
  ./upgradeMaglev.sh 25051
...
<tt>rvm use maglev-25051; maglev stop; rvm use maglev-head; maglev stop</tt>.
