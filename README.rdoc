...
The MagLev Alpha version on 2011-02-24 is 25329. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25329
  ./upgradeMaglev.sh 25329
...
<tt>rvm use maglev-25329; maglev stop; rvm use maglev-head; maglev stop</tt>.
