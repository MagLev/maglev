...
The MagLev Alpha version on 24-Feb-10 is 22907. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 22907
  ./upgradeMaglev.sh 22907
...
<tt>rvm use maglev-22907; maglev stop; rvm use maglev-head; maglev stop</tt>.
