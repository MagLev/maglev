...
The MagLev Alpha version on 2010-04-22 is 23351. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23351
  ./upgradeMaglev.sh 23351
...
<tt>rvm use maglev-23351; maglev stop; rvm use maglev-head; maglev stop</tt>.
