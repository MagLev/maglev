...
The MagLev Alpha version on 09-Feb-10 is 22851. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 22851
  ./upgradeMaglev.sh 22851
...
<tt>rvm use maglev-22851; maglev stop; rvm use maglev-head; maglev stop</tt>.
