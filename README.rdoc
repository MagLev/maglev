...
The MagLev Alpha version on 2011-02-17 is 25278. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25278
  ./upgradeMaglev.sh 25278
...
<tt>rvm use maglev-25278; maglev stop; rvm use maglev-head; maglev stop</tt>.
