...
The MagLev Alpha version on 2011-03-29 is 25882. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25882
  ./upgradeMaglev.sh 25882
...
<tt>rvm use maglev-25882; maglev stop; rvm use maglev-head; maglev stop</tt>.
