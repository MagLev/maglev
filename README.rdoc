...
The MagLev Alpha version on 2010-04-09 is 23234. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23234
  ./upgradeMaglev.sh 23234
...
<tt>rvm use maglev-23234; maglev stop; rvm use maglev-head; maglev stop</tt>.
