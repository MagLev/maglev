...
The MagLev Alpha version on 2010-05-02 is 23416. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23416
  ./upgradeMaglev.sh 23416
...
<tt>rvm use maglev-23416; maglev stop; rvm use maglev-head; maglev stop</tt>.
