...
The MagLev Alpha version on 2011-03-17 is 25489. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25489
  ./upgradeMaglev.sh 25489
...
<tt>rvm use maglev-25489; maglev stop; rvm use maglev-head; maglev stop</tt>.
