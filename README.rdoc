...
The MagLev Alpha version on 2011-03-29 is 25583. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25583
  ./upgradeMaglev.sh 25583
...
<tt>rvm use maglev-25583; maglev stop; rvm use maglev-head; maglev stop</tt>.
