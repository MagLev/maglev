...
The MagLev Alpha version on 2010-02-26 is 22919. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 22919
  ./upgradeMaglev.sh 22919
...
<tt>rvm use maglev-22919; maglev stop; rvm use maglev-head; maglev stop</tt>.
