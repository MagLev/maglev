...
The MagLev Alpha version on 2010-10-19 is 24493. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 24493
  ./upgradeMaglev.sh 24493
...
<tt>rvm use maglev-24493; maglev stop; rvm use maglev-head; maglev stop</tt>.
