...
The MagLev Alpha version on 29-Jan-10 is 22804. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 22804
  ./upgradeMaglev.sh 22804
...
<tt>rvm use maglev-22804; maglev stop; rvm use maglev-head; maglev stop</tt>.
