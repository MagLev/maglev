...
The MagLev Alpha version on 2011-02-23 is 25340. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25340
  ./upgradeMaglev.sh 25340
...
<tt>rvm use maglev-25340; maglev stop; rvm use maglev-head; maglev stop</tt>.
