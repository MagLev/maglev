...
The MagLev Alpha version on 2010-05-20 is 23530. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23530
  ./upgradeMaglev.sh 23530
...
<tt>rvm use maglev-23530; maglev stop; rvm use maglev-head; maglev stop</tt>.
