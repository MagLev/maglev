...
The MagLev Alpha version on 2011-02-01 is 25184. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25182
  ./upgradeMaglev.sh 25182
...
<tt>rvm use maglev-25182; maglev stop; rvm use maglev-head; maglev stop</tt>.
