...
The MagLev Alpha version on 18-Feb-10 is 22891. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 22891
  ./upgradeMaglev.sh 22891
...
<tt>rvm use maglev-22891; maglev stop; rvm use maglev-head; maglev stop</tt>.
