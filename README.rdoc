...
The MagLev Alpha version on 15-Jan-10 is 22725. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 22725
  ./upgradeMaglev.sh 22725
...
<tt>rvm use maglev-22683; maglev stop; rvm use maglev-22725; maglev stop</tt>.
