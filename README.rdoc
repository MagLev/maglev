...
The MagLev Alpha version on 2010-02-26 is 22920. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 22920
  ./upgradeMaglev.sh 22920
...
<tt>rvm use maglev-22920; maglev stop; rvm use maglev-head; maglev stop</tt>.
