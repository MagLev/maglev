...
The MagLev Alpha version on 2011-03-29 is 25580. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25580
  ./upgradeMaglev.sh 25580
...
<tt>rvm use maglev-25580; maglev stop; rvm use maglev-head; maglev stop</tt>.
