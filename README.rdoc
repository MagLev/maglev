...
The MagLev Alpha version on 2011-03-16 is 25479. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25479
  ./upgradeMaglev.sh 25479
...
<tt>rvm use maglev-25479; maglev stop; rvm use maglev-head; maglev stop</tt>.
