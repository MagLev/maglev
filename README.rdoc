...
The MagLev Alpha version on 2011-07-14 is 26157. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 26157
  ./upgradeMaglev.sh 26157
...
<tt>rvm use maglev-26157; maglev stop; rvm use maglev-head; maglev stop</tt>.
