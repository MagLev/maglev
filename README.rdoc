...
The MagLev Alpha version on 2011-07-14 is 26167. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 26167
  ./upgradeMaglev.sh 26167
...
<tt>rvm use maglev-26167; maglev stop; rvm use maglev-head; maglev stop</tt>.
