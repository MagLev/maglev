...
The MagLev Alpha version on 2011-03-04 is 25375. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25375
  ./upgradeMaglev.sh 25375
...
<tt>rvm use maglev-25375; maglev stop; rvm use maglev-head; maglev stop</tt>.
