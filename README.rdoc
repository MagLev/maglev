...
The MagLev Alpha version on 2010-04-16 is 23275. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23275
  ./upgradeMaglev.sh 23275
...
<tt>rvm use maglev-23275; maglev stop; rvm use maglev-head; maglev stop</tt>.
