...
The MagLev Alpha version on 2011-06-14 is 25987. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25987
  ./upgradeMaglev.sh 25987
...
<tt>rvm use maglev-25987; maglev stop; rvm use maglev-head; maglev stop</tt>.
