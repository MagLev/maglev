...
The MagLev Alpha version on 2010-10-15 is 24478. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 24478
  ./upgradeMaglev.sh 24478
...
<tt>rvm use maglev-24478; maglev stop; rvm use maglev-head; maglev stop</tt>.
