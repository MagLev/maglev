...
The MagLev Alpha version on 2011-04-11 is 25681. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25681
  ./upgradeMaglev.sh 25681
...
<tt>rvm use maglev-25681; maglev stop; rvm use maglev-head; maglev stop</tt>.
