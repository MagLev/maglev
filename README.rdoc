...
The MagLev Alpha version on 15-Feb-10 is 22873. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 22873
  ./upgradeMaglev.sh 22873
...
<tt>rvm use maglev-22873; maglev stop; rvm use maglev-head; maglev stop</tt>.
