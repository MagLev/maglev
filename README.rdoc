...
The MagLev Alpha version on 2011-02-08 is 25201. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25201
  ./upgradeMaglev.sh 25201
...
<tt>rvm use maglev-25201; maglev stop; rvm use maglev-head; maglev stop</tt>.
