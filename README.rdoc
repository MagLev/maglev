...
The MagLev Alpha version on 2010-12-06 is 24811. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 24811
  ./upgradeMaglev.sh 24811
...
<tt>rvm use maglev-24811; maglev stop; rvm use maglev-head; maglev stop</tt>.
