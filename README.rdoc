...
The MagLev Alpha version on 2010-04-12 is 23245. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23245
  ./upgradeMaglev.sh 23245
...
<tt>rvm use maglev-23245; maglev stop; rvm use maglev-head; maglev stop</tt>.
