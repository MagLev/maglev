...
The MagLev Alpha version on 2011-04-13 is 25701. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25701
  ./upgradeMaglev.sh 25701
...
<tt>rvm use maglev-25701; maglev stop; rvm use maglev-head; maglev stop</tt>.
