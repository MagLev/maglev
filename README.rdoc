...
The MagLev Alpha version on 2011-03-18 is 25496. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25496
  ./upgradeMaglev.sh 25496
...
<tt>rvm use maglev-25496; maglev stop; rvm use maglev-head; maglev stop</tt>.
