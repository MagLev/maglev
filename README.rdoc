...
The MagLev Alpha version on 2011-04-05 is 25667. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25665
  ./upgradeMaglev.sh 25665
...
<tt>rvm use maglev-25665; maglev stop; rvm use maglev-head; maglev stop</tt>.
