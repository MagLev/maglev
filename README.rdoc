...
The MagLev Alpha version on 2010-09-13 is 24228. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 24228
  ./upgradeMaglev.sh 24228
...
<tt>rvm use maglev-24228; maglev stop; rvm use maglev-head; maglev stop</tt>.
