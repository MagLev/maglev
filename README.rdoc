...
The MagLev Alpha version on 2011-08-09 is 26384. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 26384
  ./upgradeMaglev.sh 26384
...
<tt>rvm use maglev-26384; maglev stop; rvm use maglev-head; maglev stop</tt>.
