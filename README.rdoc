...
The MagLev Alpha version on 2010-02-27 is 22931. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 22931
  ./upgradeMaglev.sh 22931
...
<tt>rvm use maglev-22931; maglev stop; rvm use maglev-head; maglev stop</tt>.
