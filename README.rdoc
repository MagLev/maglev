...
The MagLev Alpha version on 2011-03-24 is 25549. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25549
  ./upgradeMaglev.sh 25549
...
<tt>rvm use maglev-25549; maglev stop; rvm use maglev-head; maglev stop</tt>.
