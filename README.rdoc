...
The MagLev Alpha version on 2010-08-11 is 24027. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 24027
  ./upgradeMaglev.sh 24027
...
<tt>rvm use maglev-24027; maglev stop; rvm use maglev-head; maglev stop</tt>.
