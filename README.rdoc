...
The MagLev Alpha version on 2011-01-06 is 24983. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 24983
  ./upgradeMaglev.sh 24983
...
<tt>rvm use maglev-24983; maglev stop; rvm use maglev-head; maglev stop</tt>.
