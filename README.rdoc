...
The MagLev Alpha version on 2010-04-06 is 23188. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23188
  ./upgradeMaglev.sh 23188
...
<tt>rvm use maglev-23188; maglev stop; rvm use maglev-head; maglev stop</tt>.
