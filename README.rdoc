...
The MagLev Alpha version on 2010-11-01 is 24566. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 24566
  ./upgradeMaglev.sh 24566
...
<tt>rvm use maglev-24566; maglev stop; rvm use maglev-head; maglev stop</tt>.
