...
The MagLev Alpha version on 2011-08-10 is 26398. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 26398
  ./upgradeMaglev.sh 26398
...
<tt>rvm use maglev-26398; maglev stop; rvm use maglev-head; maglev stop</tt>.
