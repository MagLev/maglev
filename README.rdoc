...
The MagLev Alpha version on 2010-05-14 is 23508. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23508
  ./upgradeMaglev.sh 23508
...
<tt>rvm use maglev-23508; maglev stop; rvm use maglev-head; maglev stop</tt>.
