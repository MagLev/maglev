...
The MagLev Alpha version on 2011-03-16 is 25476. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25476
  ./upgradeMaglev.sh 25476
...
<tt>rvm use maglev-25476; maglev stop; rvm use maglev-head; maglev stop</tt>.
