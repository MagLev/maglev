...
The MagLev Alpha version on 2011-06-24 is 26063. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 26063
  ./upgradeMaglev.sh 26063
...
<tt>rvm use maglev-26063; maglev stop; rvm use maglev-head; maglev stop</tt>.
