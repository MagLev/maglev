...
The MagLev Alpha version on 2010-10-15 is 24479. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 24479
  ./upgradeMaglev.sh 24479
...
<tt>rvm use maglev-24479; maglev stop; rvm use maglev-head; maglev stop</tt>.
