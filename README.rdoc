...
The MagLev Alpha version on 2011-01-07 is 24984. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 24984
  ./upgradeMaglev.sh 24984
...
<tt>rvm use maglev-24984; maglev stop; rvm use maglev-head; maglev stop</tt>.
