...
The MagLev Alpha version on 2011-04-28 is 25769. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25769
  ./upgradeMaglev.sh 25769
...
<tt>rvm use maglev-25769; maglev stop; rvm use maglev-head; maglev stop</tt>.
