...
The MagLev Alpha version on 2010-03-01 is 22947. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 22947
  ./upgradeMaglev.sh 22947
...
<tt>rvm use maglev-22947; maglev stop; rvm use maglev-head; maglev stop</tt>.
