...
The MagLev Alpha version on 2011-01-28 is 25127. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25127
  ./upgradeMaglev.sh 25127
...
<tt>rvm use maglev-25127; maglev stop; rvm use maglev-head; maglev stop</tt>.
