...
The MagLev Alpha version on 2011-04-22 is 25752. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25752
  ./upgradeMaglev.sh 25752
...
<tt>rvm use maglev-25752; maglev stop; rvm use maglev-head; maglev stop</tt>.
