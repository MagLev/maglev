...
The MagLev Alpha version on 2010-04-02 is 23171. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23171
  ./upgradeMaglev.sh 23171
...
<tt>rvm use maglev-23171; maglev stop; rvm use maglev-head; maglev stop</tt>.
