...
The MagLev Alpha version on 2010-06-17 is 23673. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23673
  ./upgradeMaglev.sh 23673
...
<tt>rvm use maglev-23673; maglev stop; rvm use maglev-head; maglev stop</tt>.
