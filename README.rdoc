...
The MagLev Alpha version on 2010-06-10 is 23569. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23569
  ./upgradeMaglev.sh 23569
...
<tt>rvm use maglev-23569; maglev stop; rvm use maglev-head; maglev stop</tt>.
