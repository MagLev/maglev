...
The MagLev Alpha version on 2011-04-08 is 25671. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25671
  ./upgradeMaglev.sh 25671
...
<tt>rvm use maglev-25671; maglev stop; rvm use maglev-head; maglev stop</tt>.
