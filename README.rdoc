...
The MagLev Alpha version on 2011-03-11 is 25439. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25439
  ./upgradeMaglev.sh 25439
...
<tt>rvm use maglev-25439; maglev stop; rvm use maglev-head; maglev stop</tt>.
