...
The MagLev Alpha version on 2011-04-12 is 25692. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25692
  ./upgradeMaglev.sh 25692
...
<tt>rvm use maglev-25692; maglev stop; rvm use maglev-head; maglev stop</tt>.
