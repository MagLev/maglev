...
The MagLev Alpha version on 12-Feb-10 is 22872. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 22872
  ./upgradeMaglev.sh 22872
...
<tt>rvm use maglev-22872; maglev stop; rvm use maglev-head; maglev stop</tt>.
