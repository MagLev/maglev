...
The MagLev Alpha version on 2010-09-08 is 24222. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 24222
  ./upgradeMaglev.sh 24222
...
<tt>rvm use maglev-24222; maglev stop; rvm use maglev-head; maglev stop</tt>.
