...
The MagLev Alpha version on 2010-06-23 is 23741. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23741
  ./upgradeMaglev.sh 23741
...
<tt>rvm use maglev-23741; maglev stop; rvm use maglev-head; maglev stop</tt>.
