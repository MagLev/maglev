...
The MagLev Alpha version on 2010-04-06 is 23189. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23189
  ./upgradeMaglev.sh 23189
...
<tt>rvm use maglev-23189; maglev stop; rvm use maglev-head; maglev stop</tt>.
