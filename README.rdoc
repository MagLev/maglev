...
The MagLev Alpha version on 2011-06-21 is 26024. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 26024
  ./upgradeMaglev.sh 26024
...
<tt>rvm use maglev-26024; maglev stop; rvm use maglev-head; maglev stop</tt>.
