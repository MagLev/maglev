...
The MagLev Alpha version on 2010-05-20 is 23529. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23529
  ./upgradeMaglev.sh 23529
...
<tt>rvm use maglev-23529; maglev stop; rvm use maglev-head; maglev stop</tt>.
