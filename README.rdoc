...
The MagLev Alpha version on 2011-03-23 is 25535. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25535
  ./upgradeMaglev.sh 25535
...
<tt>rvm use maglev-25535; maglev stop; rvm use maglev-head; maglev stop</tt>.
