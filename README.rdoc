...
The MagLev Alpha version on 2011-04-04 is 25633. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25633
  ./upgradeMaglev.sh 25633
...
<tt>rvm use maglev-25633; maglev stop; rvm use maglev-head; maglev stop</tt>.
