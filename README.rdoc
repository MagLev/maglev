...
The MagLev Alpha version on 2011-07-13 is 26153. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 26153
  ./upgradeMaglev.sh 26153
...
<tt>rvm use maglev-26153; maglev stop; rvm use maglev-head; maglev stop</tt>.
