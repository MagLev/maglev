...
The MagLev Alpha version on 2011-02-23 is 25314. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25314
  ./upgradeMaglev.sh 25314
...
<tt>rvm use maglev-25314; maglev stop; rvm use maglev-head; maglev stop</tt>.
