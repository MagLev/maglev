...
The MagLev Alpha version on 2011-01-07 is 24980. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 24980
  ./upgradeMaglev.sh 24980
...
<tt>rvm use maglev-24980; maglev stop; rvm use maglev-head; maglev stop</tt>.
