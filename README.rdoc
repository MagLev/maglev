...
The MagLev Alpha version on 2010-04-29 is 23400. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23400
  ./upgradeMaglev.sh 23400
...
<tt>rvm use maglev-23400; maglev stop; rvm use maglev-head; maglev stop</tt>.
