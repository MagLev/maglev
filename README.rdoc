...
The MagLev Alpha version on 2011-05-17 is 25876. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25876
  ./upgradeMaglev.sh 25876
...
<tt>rvm use maglev-25876; maglev stop; rvm use maglev-head; maglev stop</tt>.
