...
The MagLev Alpha version on 2010-04-06 is 23187. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23187
  ./upgradeMaglev.sh 23187
...
<tt>rvm use maglev-23187; maglev stop; rvm use maglev-head; maglev stop</tt>.
