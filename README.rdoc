...
The MagLev Alpha version on 2011-08-12 is 26418. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 26418
  ./upgradeMaglev.sh 26418
...
<tt>rvm use maglev-26418; maglev stop; rvm use maglev-head; maglev stop</tt>.
