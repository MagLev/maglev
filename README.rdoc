...
The MagLev Alpha version on 2011-05-27 is 25913. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25913
  ./upgradeMaglev.sh 25913
...
<tt>rvm use maglev-25913; maglev stop; rvm use maglev-head; maglev stop</tt>.
