...
The MagLev Alpha version on 2011-08-17 is 26430. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 26430
  ./upgradeMaglev.sh 26430
...
<tt>rvm use maglev-26430; maglev stop; rvm use maglev-head; maglev stop</tt>.
