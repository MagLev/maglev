...
The MagLev Alpha version on 2011-02-09 is 25218. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25218
  ./upgradeMaglev.sh 25218
...
<tt>rvm use maglev-25218; maglev stop; rvm use maglev-head; maglev stop</tt>.
