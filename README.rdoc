...
The MagLev Alpha version on 2010-05-23 is 23540. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23540
  ./upgradeMaglev.sh 23540
...
<tt>rvm use maglev-23540; maglev stop; rvm use maglev-head; maglev stop</tt>.
