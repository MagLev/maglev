...
The MagLev Alpha version on 2010-10-20 is 24516. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 24516
  ./upgradeMaglev.sh 24516
...
<tt>rvm use maglev-24516; maglev stop; rvm use maglev-head; maglev stop</tt>.
