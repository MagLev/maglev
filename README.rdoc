...
The MagLev Alpha version on 2010-11-04 is 24610. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 24610
  ./upgradeMaglev.sh 24610
...
<tt>rvm use maglev-24610; maglev stop; rvm use maglev-head; maglev stop</tt>.
