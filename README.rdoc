...
The MagLev Alpha version on 2010-05-07 is 23464. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23464
  ./upgradeMaglev.sh 23464
...
<tt>rvm use maglev-23464; maglev stop; rvm use maglev-head; maglev stop</tt>.
