...
The MagLev Alpha version on 2011-02-15 is 25261. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25261
  ./upgradeMaglev.sh 25261
...
<tt>rvm use maglev-25261; maglev stop; rvm use maglev-head; maglev stop</tt>.
