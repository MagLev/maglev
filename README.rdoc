...
The MagLev Alpha version on 2010-08-13 is 24067. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 24067
  ./upgradeMaglev.sh 24067
...
<tt>rvm use maglev-24067; maglev stop; rvm use maglev-head; maglev stop</tt>.
