...
The MagLev Alpha version on 2011-05-17 is 25874. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25874
  ./upgradeMaglev.sh 25874
...
<tt>rvm use maglev-25874; maglev stop; rvm use maglev-head; maglev stop</tt>.
