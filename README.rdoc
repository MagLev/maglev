...
The MagLev Alpha version on 2011-05-09 is 25832. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25832
  ./upgradeMaglev.sh 25832
...
<tt>rvm use maglev-25832; maglev stop; rvm use maglev-head; maglev stop</tt>.
