...
The MagLev Alpha version on 2010-12-21 is 24904. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 24904
  ./upgradeMaglev.sh 24904
...
<tt>rvm use maglev-24904; maglev stop; rvm use maglev-head; maglev stop</tt>.
