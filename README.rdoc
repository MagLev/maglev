...
The MagLev Alpha version on 2010-08-27 is 24167. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 24167
  ./upgradeMaglev.sh 24167
...
<tt>rvm use maglev-24167; maglev stop; rvm use maglev-head; maglev stop</tt>.
