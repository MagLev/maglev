...
The MagLev Alpha version on 2010-07-02 is 23767. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23767
  ./upgradeMaglev.sh 23767
...
<tt>rvm use maglev-23767; maglev stop; rvm use maglev-head; maglev stop</tt>.
