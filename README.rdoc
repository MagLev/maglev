...
The MagLev Alpha version on 2011-04-20 is 25743. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25743
  ./upgradeMaglev.sh 25743
...
<tt>rvm use maglev-25743; maglev stop; rvm use maglev-head; maglev stop</tt>.
