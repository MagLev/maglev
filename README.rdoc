...
The MagLev Alpha version on 2010-02-27 is 22932. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 22932
  ./upgradeMaglev.sh 22932
...
<tt>rvm use maglev-22932; maglev stop; rvm use maglev-head; maglev stop</tt>.
