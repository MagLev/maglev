...
The MagLev Alpha version on 2011-02-16 is 25267. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25267
  ./upgradeMaglev.sh 25267
...
<tt>rvm use maglev-25267; maglev stop; rvm use maglev-head; maglev stop</tt>.
