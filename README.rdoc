...
The MagLev Alpha version on 2011-03-10 is 25414. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25414
  ./upgradeMaglev.sh 25414
...
<tt>rvm use maglev-25414; maglev stop; rvm use maglev-head; maglev stop</tt>.
