...
The MagLev Alpha version on 2010-08-10 is 24010. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 24010
  ./upgradeMaglev.sh 24010
...
<tt>rvm use maglev-24010; maglev stop; rvm use maglev-head; maglev stop</tt>.
