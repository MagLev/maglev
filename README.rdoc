...
The MagLev Alpha version on 2010-04-14 is 23265. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23265
  ./upgradeMaglev.sh 23265
...
<tt>rvm use maglev-23265; maglev stop; rvm use maglev-head; maglev stop</tt>.
