...
The MagLev Alpha version on 2011-04-05 is 25646. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25646
  ./upgradeMaglev.sh 25646
...
<tt>rvm use maglev-25646; maglev stop; rvm use maglev-head; maglev stop</tt>.
