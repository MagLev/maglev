...
The MagLev Alpha version on 2010-04-13 is 23251. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23251
  ./upgradeMaglev.sh 23251
...
<tt>rvm use maglev-23251; maglev stop; rvm use maglev-head; maglev stop</tt>.
