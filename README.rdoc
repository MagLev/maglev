...
The MagLev Alpha version on 2010-04-13 is 23252. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23252
  ./upgradeMaglev.sh 23252
...
<tt>rvm use maglev-23252; maglev stop; rvm use maglev-head; maglev stop</tt>.
