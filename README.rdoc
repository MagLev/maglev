...
The MagLev Alpha version on 2011-08-03 is 26334. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 26334
  ./upgradeMaglev.sh 26334
...
<tt>rvm use maglev-26334; maglev stop; rvm use maglev-head; maglev stop</tt>.
