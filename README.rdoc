...
The MagLev Alpha version on 2010-03-18 is 23049. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23049
  ./upgradeMaglev.sh 23049
...
<tt>rvm use maglev-23049; maglev stop; rvm use maglev-head; maglev stop</tt>.
