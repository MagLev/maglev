...
The MagLev Alpha version on 2011-03-30 is 25593. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25593
  ./upgradeMaglev.sh 25593
...
<tt>rvm use maglev-25593; maglev stop; rvm use maglev-head; maglev stop</tt>.
