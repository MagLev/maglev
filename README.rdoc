...
The MagLev Alpha version on 2010-05-07 is 23462. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23462
  ./upgradeMaglev.sh 23462
...
<tt>rvm use maglev-23462; maglev stop; rvm use maglev-head; maglev stop</tt>.
