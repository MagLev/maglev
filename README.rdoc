...
The MagLev Alpha version on 2011-06-09 is 25953. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25953
  ./upgradeMaglev.sh 25953
...
<tt>rvm use maglev-25953; maglev stop; rvm use maglev-head; maglev stop</tt>.
