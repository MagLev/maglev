...
The MagLev Alpha version on 2011-07-22 is 26243. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 26243
  ./upgradeMaglev.sh 26243
...
<tt>rvm use maglev-26243; maglev stop; rvm use maglev-head; maglev stop</tt>.
