...
The MagLev Alpha version on 2011-07-21 is 26231. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 26231
  ./upgradeMaglev.sh 26231
...
<tt>rvm use maglev-26231; maglev stop; rvm use maglev-head; maglev stop</tt>.
