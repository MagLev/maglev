...
The MagLev Alpha version on 2010-06-03 is 23570. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23570
  ./upgradeMaglev.sh 23570
...
<tt>rvm use maglev-23570; maglev stop; rvm use maglev-head; maglev stop</tt>.
