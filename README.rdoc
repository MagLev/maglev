...
The MagLev Alpha version on 2010-04-12 is 23244. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23244
  ./upgradeMaglev.sh 23244
...
<tt>rvm use maglev-23244; maglev stop; rvm use maglev-head; maglev stop</tt>.
