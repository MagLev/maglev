...
The MagLev Alpha version on 2011-03-08 is 25393. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25393
  ./upgradeMaglev.sh 25393
...
<tt>rvm use maglev-25393; maglev stop; rvm use maglev-head; maglev stop</tt>.
