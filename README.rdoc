...
The MagLev Alpha version on 2010-07-18 is 23832. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23832
  ./upgradeMaglev.sh 23832
...
<tt>rvm use maglev-23832; maglev stop; rvm use maglev-head; maglev stop</tt>.
