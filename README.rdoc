...
The MagLev Alpha version on 2010-12-14 is 24864. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 24864
  ./upgradeMaglev.sh 24864
...
<tt>rvm use maglev-24864; maglev stop; rvm use maglev-head; maglev stop</tt>.
