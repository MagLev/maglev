...
see the Persistence[link:files/docs/persistence.html] file in the docs directory.
...
Persistence[link:files/docs/persistence.html]:: Persistence and transactions
