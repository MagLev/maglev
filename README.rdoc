...
The MagLev Alpha version on 2011-06-15 is 26011. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 26011
  ./upgradeMaglev.sh 26011
...
<tt>rvm use maglev-26011; maglev stop; rvm use maglev-head; maglev stop</tt>.
