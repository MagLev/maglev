...
The MagLev Alpha version on 2011-02-09 is 25223. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25223
  ./upgradeMaglev.sh 25223
...
<tt>rvm use maglev-25223; maglev stop; rvm use maglev-head; maglev stop</tt>.
