...
The MagLev Alpha version on 2011-07-28 is 26290. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 26290
  ./upgradeMaglev.sh 26290
...
<tt>rvm use maglev-26290; maglev stop; rvm use maglev-head; maglev stop</tt>.
