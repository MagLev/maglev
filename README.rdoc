...
The MagLev Alpha version on 2010-11-29 is 24756. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 24756
  ./upgradeMaglev.sh 24756
...
<tt>rvm use maglev-24756; maglev stop; rvm use maglev-head; maglev stop</tt>.
