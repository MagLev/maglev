...
The MagLev Alpha version on 2010-09-08 is 24207. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 24207
  ./upgradeMaglev.sh 24207
...
<tt>rvm use maglev-24207; maglev stop; rvm use maglev-head; maglev stop</tt>.
