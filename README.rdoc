...
The MagLev Alpha version on 2011-03-01 is 25352. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25352
  ./upgradeMaglev.sh 25352
...
<tt>rvm use maglev-25352; maglev stop; rvm use maglev-head; maglev stop</tt>.
