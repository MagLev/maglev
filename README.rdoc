...
The MagLev Alpha version on 2011-06-09 is 25955. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25955
  ./upgradeMaglev.sh 25955
...
<tt>rvm use maglev-25955; maglev stop; rvm use maglev-head; maglev stop</tt>.
