...
The MagLev Alpha version on 2010-07-18 is 23913. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23913
  ./upgradeMaglev.sh 23913
...
<tt>rvm use maglev-23913; maglev stop; rvm use maglev-head; maglev stop</tt>.
