...
The MagLev Alpha version on 2011-03-30 is 25598. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25598
  ./upgradeMaglev.sh 25598
...
<tt>rvm use maglev-25598; maglev stop; rvm use maglev-head; maglev stop</tt>.
