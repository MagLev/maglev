...
The MagLev Alpha version on 2011-07-13 is 26148. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 26148
  ./upgradeMaglev.sh 26148
...
<tt>rvm use maglev-26148; maglev stop; rvm use maglev-head; maglev stop</tt>.
