...
The MagLev Alpha version on 2011-08-01 is 26313. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 26313
  ./upgradeMaglev.sh 26313
...
<tt>rvm use maglev-26313; maglev stop; rvm use maglev-head; maglev stop</tt>.
