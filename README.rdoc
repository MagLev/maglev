...
The MagLev Alpha version on 2010-09-08 is 24208. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 24208
  ./upgradeMaglev.sh 24208
...
<tt>rvm use maglev-24208; maglev stop; rvm use maglev-head; maglev stop</tt>.
