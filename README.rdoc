...
The MagLev Alpha version on 2010-06-03 is 23577. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23577
  ./upgradeMaglev.sh 23577
...
<tt>rvm use maglev-23577; maglev stop; rvm use maglev-head; maglev stop</tt>.
