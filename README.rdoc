...
The MagLev Alpha version on 2011-02-01 is 25151. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25151
  ./upgradeMaglev.sh 25151
...
<tt>rvm use maglev-25151; maglev stop; rvm use maglev-head; maglev stop</tt>.
