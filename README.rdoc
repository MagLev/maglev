...
The MagLev Alpha version on 2011-03-22 is 25523. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25523
  ./upgradeMaglev.sh 25523
...
<tt>rvm use maglev-25523; maglev stop; rvm use maglev-head; maglev stop</tt>.
