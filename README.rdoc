...
The MagLev Alpha version on 2010-10-01 is 24407. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 24407
  ./upgradeMaglev.sh 24407
...
<tt>rvm use maglev-24407; maglev stop; rvm use maglev-head; maglev stop</tt>.
