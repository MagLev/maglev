...
The MagLev Alpha version on 2011-03-31 is 25607. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25607
  ./upgradeMaglev.sh 25607
...
<tt>rvm use maglev-25607; maglev stop; rvm use maglev-head; maglev stop</tt>.
