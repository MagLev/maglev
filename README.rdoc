...
The MagLev Alpha version on 2011-02-04 is 25185. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25185
  ./upgradeMaglev.sh 25185
...
<tt>rvm use maglev-25185; maglev stop; rvm use maglev-head; maglev stop</tt>.
