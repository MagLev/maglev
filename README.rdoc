...
The MagLev Alpha version on 2010-03-22 is 23101. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23101
  ./upgradeMaglev.sh 23101
...
<tt>rvm use maglev-23101; maglev stop; rvm use maglev-head; maglev stop</tt>.
