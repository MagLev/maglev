...
The MagLev Alpha version on 2011-03-03 is 25370. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25370
  ./upgradeMaglev.sh 25370
...
<tt>rvm use maglev-25370; maglev stop; rvm use maglev-head; maglev stop</tt>.
