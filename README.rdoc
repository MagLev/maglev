...
The MagLev Alpha version on 2010-08-23 is 24125. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 24125
  ./upgradeMaglev.sh 24125
...
<tt>rvm use maglev-24125; maglev stop; rvm use maglev-head; maglev stop</tt>.
