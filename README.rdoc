...
The MagLev Alpha version on 2011-05-10 is 25838. Check for later versions on
...
<tt>rvm use maglev-25838; maglev stop; rvm use maglev-head; maglev stop</tt>.
