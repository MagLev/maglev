...
The MagLev Alpha version on 2011-08-08 is 26372. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 26372
  ./upgradeMaglev.sh 26372
...
<tt>rvm use maglev-26372; maglev stop; rvm use maglev-head; maglev stop</tt>.
