...
The MagLev Alpha version on 2011-05-26 is 25905. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25905
  ./upgradeMaglev.sh 25905
...
<tt>rvm use maglev-25905; maglev stop; rvm use maglev-head; maglev stop</tt>.
