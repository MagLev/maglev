...
The MagLev Alpha version on 2011-07-24 is 26245. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 26245
  ./upgradeMaglev.sh 26245
...
<tt>rvm use maglev-26245; maglev stop; rvm use maglev-head; maglev stop</tt>.
