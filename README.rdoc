...
The MagLev Alpha version on 2011-07-26 is 26278. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 26278
  ./upgradeMaglev.sh 26278
...
<tt>rvm use maglev-26278; maglev stop; rvm use maglev-head; maglev stop</tt>.
