...
The MagLev Alpha version on 2010-02-27 is 22926. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 22926
  ./upgradeMaglev.sh 22926
...
<tt>rvm use maglev-22926; maglev stop; rvm use maglev-head; maglev stop</tt>.
