...
The MagLev Alpha version on 2010-03-19 is 23082. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23082
  ./upgradeMaglev.sh 23082
...
<tt>rvm use maglev-23082; maglev stop; rvm use maglev-head; maglev stop</tt>.
