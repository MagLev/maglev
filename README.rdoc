...
The MagLev Alpha version on 2011-02-04 is 25186. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25186
  ./upgradeMaglev.sh 25186
...
<tt>rvm use maglev-25186; maglev stop; rvm use maglev-head; maglev stop</tt>.
