...
The MagLev Alpha version on 2011-02-17 is 25282. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25282
  ./upgradeMaglev.sh 25282
...
<tt>rvm use maglev-25282; maglev stop; rvm use maglev-head; maglev stop</tt>.
