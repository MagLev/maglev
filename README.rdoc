...
The MagLev Alpha version on 2011-02-07 is 25191. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25191
  ./upgradeMaglev.sh 25191
...
<tt>rvm use maglev-25191; maglev stop; rvm use maglev-head; maglev stop</tt>.
