...
The MagLev Alpha version on 2011-02-01 is 25153. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25153
  ./upgradeMaglev.sh 25153
...
<tt>rvm use maglev-25153; maglev stop; rvm use maglev-head; maglev stop</tt>.
