...
The MagLev Alpha version on 2010-06-12 is 23611. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23611
  ./upgradeMaglev.sh 23611
...
<tt>rvm use maglev-23611; maglev stop; rvm use maglev-head; maglev stop</tt>.
