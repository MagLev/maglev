...
The MagLev Alpha version on 2011-08-12 is 26414. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 26414
  ./upgradeMaglev.sh 26414
...
<tt>rvm use maglev-26414; maglev stop; rvm use maglev-head; maglev stop</tt>.
