...
The MagLev Alpha version on 2010-05-04 is 23447. Check for later versions on 
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 23447
  ./upgradeMaglev.sh 23447
...
<tt>rvm use maglev-23447; maglev stop; rvm use maglev-head; maglev stop</tt>.
