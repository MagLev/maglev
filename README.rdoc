...
The MagLev Alpha version on 2011-05-23 is 25889. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25889
  ./upgradeMaglev.sh 25889
...
<tt>rvm use maglev-25889; maglev stop; rvm use maglev-head; maglev stop</tt>.
