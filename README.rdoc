...
The MagLev Alpha version on 2011-04-15 is 25716. Check for later versions on
...
version number as a parameter, <em>e.g.</em>
  ./installMaglev.sh 25716
  ./upgradeMaglev.sh 25716
...
<tt>rvm use maglev-25716; maglev stop; rvm use maglev-head; maglev stop</tt>.
