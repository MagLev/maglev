...
or
  $ cd $MAGLEV_HOME/lib/maglev/gems/1.8/gems/activesupport-3.0.0.rc
  $ patch -p2 < $MAGLEV_HOME/examples/rails/patches/active_support_2.diff
  $ patch -p2 < $MAGLEV_HOME/examples/rails/patches/active_support_3.diff
