...
Can you run "rails new" w/o the bundle?
...
for rails versions 3.0.0, 3.0.3, 3.0.4
     $ cd $MAGLEV_HOME/examples/rails
...
1. Generate the application:
     $ $MAGLEV_HOME/bin/rails new myapp --skip-bundle

2. Edit <tt>myapp/Gemfile</tt>:

   Commment out the "gem 'coffee-script'" line
