...
pages using a patched version of Rails 3.0.0, or Rails 3.0.3.  The
<tt>Rakefile</tt> provides tasks to setup your MagLev environment with the
correct gems, including the (patched) Rails Gems.
