...
8. Generate new controller: <tt>$MAGLEV_HOME/bin/rails generate controller
   home index</tt> (works)
9. Running migrations: <tt>$MAGLEV_HOME/bin/rake db:migrate</tt> (works)
...
With the posts, you can create a new one, but if you go to edit it,
(http://localhost:3000/posts/1/edit), there is an error.
