...
#   desc "Start MagLev SCGI VMs (default 1, 'config/config.ru')"
#   task :maglev, :count, :rackup_file, :needs => ['log'] do |t, args|
#     args.with_defaults :rackup_file => 'config/config.ru', :count => '1'
...
#     args.with_defaults :rackup_file => 'config/config.ru', :version => '1.8.7'
