# BEGIN GemStone
# Guts of ruby-fcgi gem imported into MagLev.  This is from version 0.8.9
# of the gem, available from Ruby Gems.
#
# See ./ruby-fcgi-License.txt for the license file.
#
# The ruby-fcgi gem does not allow a non-extension based install
# from gem, so rather than go through all of the complexity of explaining
# how to install, we just copy the one file we need here.
#
# END GemStone
puts "======= #{__FILE__}"
=begin
