...
Tree2D (k=2), is shown in this example using the Google Maps API as the GUI.
...
Prerequisite: You must have the json_pure gem installed:

  $ maglev-gem install json_pure
