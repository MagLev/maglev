...
To use MySQL, install the ruby-mysql gem:
...
You also need to run MagLev with the <tt>-MallIvsDynamic</tt> flag.

== Setup

MySQL must already be running, thhen edit the configuration section of
